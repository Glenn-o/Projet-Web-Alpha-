...
<section id="main">
    ...
    <form action="index.php?page=login&action=tryConnexion" method="POST">
...
<p id="message_error"><?= $message ?></p>
    <a href="index.php?page=register"><p>Vous n'avez pas de compte ? <span>Créer un compte</span></p></a>
</section>
